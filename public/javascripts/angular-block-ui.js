...
blkUI.constant('blockUIConfig', {
    ...
    delay: 250,
    // message: "Loading",
	// template: '<div style="width: 1000px; height: 1000px;"><img src="images/spinner.gif"/></div>',
    autoBlock: true,
...
angular.module('blockUI').run(['$templateCache', function($templateCache){
  $templateCache.put('angular-block-ui/angular-block-ui.ng.html', '<div class=\"block-ui-overlay\"></div><div class=\"block-ui-message-container\" aria-live=\"assertive\" aria-atomic=\"true\"><div class=\"block-ui-message\" ng-class=\"$_blockUiMessageClass\"><img src="images/spinner.gif"/></div></div>');
}]);
})(angular);
